...
| | 功能 | 简介 |
|:---:|------|------|
| 🚀 | **一键启动** | 启动/停止 ComfyUI，内置浏览器工作区，实时终端日志 |
| 📦 | **环境管理** | 部署 ComfyUI，管理多个安装实例，切换 PyTorch/CUDA 版本 |
| 🔍 | **模型查找** | 分析工作流，自动匹配缺失模型，批量下载自 HuggingFace / ModelScope / Civitai |
| 🧩 | **插件管理** | 从 Git URL 安装自定义节点，管理依赖，批量启用/禁用 |
| 🗂️ | **模型库** | 按分类浏览本地模型，跨安装包重复检测 |
| 🤖 | **AI 助手** | 聊天式日志诊断，确认后自动修复，一键回滚 |
| ⬇️ | **下载管理** | 多任务下载，暂停/恢复，Aria2 加速支持 |
| 🎨 | **个性化** | 深色/浅色主题，多种配色方案，中文/English，Fluent Design |
...
<details>
<summary><b>🔍 工作流 — 模型查找与下载</b></summary>
...
<details>
<summary><b>🧩 插件 — 自定义节点安装与管理</b></summary>
...
<details>
<summary><b>🗂️ 模型 — 模型库与下载管理器</b></summary>
...
- **Bug 反馈 / 功能建议**：[GitHub Issues](https://github.com/hu-haibin/ModelFinder-Releases/issues)
- 如果 ModelFinder 对你有帮助，欢迎给个 Star

---

## 关于

ModelFinder 是为 [ComfyUI](https://github.com/comfyanonymous/ComfyUI) 生态打造的第三方工具。本仓库提供编译后的发行版和问题追踪。

ComfyUI 是独立的开源项目 — ModelFinder 的目标是补充和增强 ComfyUI 的使用体验，而非替代其任何功能。
